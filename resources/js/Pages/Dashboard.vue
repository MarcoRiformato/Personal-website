...
<div class="relative isolate pt-14 sm:px-4">
  <!-- Benvenuto -->
  <div
  id="benvenuto"
  ...
  <div
  id="servizi"
  class=" mx-auto max-w-7xl sm:px-10 lg:px-8">
  <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
      <div class="px-4 lg:row-start-2 lg:max-w-md ">
      ...
      <div class="px-4 max-w-xl lg:row-start-3 lg:mt-10 lg:max-w-md lg:border-t lg:border-white/10 lg:pt-10">
      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div class="lg:ml-auto lg:pl-4 lg:pt-4">
          <div class="lg:max-w-lg">
            <h2 class="text-base font-semibold leading-7">testo</h2>
            <p class="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">SEO e CRO</p>
            <p class="mt-6 text-lg leading-8">Faremo in modo che tu appaia più in alto nelle ricerche di Google e che il tuo sito web sia ottimizzato per le vendite</p>
            <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 lg:max-w-none">
              <div v-for="feature in secondo" :key="feature.name" class="relative pl-9">
  ...
  <div class="-mt-20 mx-auto max-w-7xl sm:px-6 sm:py-32 lg:px-8">
    <div class="relative isolate overflow-hidden bg-gray-700 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
