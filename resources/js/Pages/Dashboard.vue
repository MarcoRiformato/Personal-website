...
class="-mt-20 mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
    ...
    <p class="mt-6 text-lg leading-8">Non solo un sito web: una soluzione completa per l'avvocato moderno che vuole crescere e prosperare nell'ambiente online.</p>
