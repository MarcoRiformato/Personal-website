...
<div class="overflow-hidden bg-primary-content py-24 sm:py-32">
<div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
    <div class="lg:ml-auto lg:pl-4 lg:pt-4">
        <div class="lg:max-w-lg">
        <h2 class="text-base font-semibold leading-7 text-secondary">Deploy faster</h2>
        <p class="mt-2 text-3xl font-bold tracking-tight sm:text-4xl text-primary">Sviluppo mobile</p>
        ...
        <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 lg:max-w-none">
            ...
            <dt class="inline font-semibold">
                <component :is="feature.icon" class="absolute left-1 top-1 h-5 w-5 text-info" aria-hidden="true" />
