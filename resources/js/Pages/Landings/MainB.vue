...
<div class="bg-gray-900 py-8">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-300">Non si tratta della solita agenzie generalista, ma di un percorso dedicato per il marketin online degli studi legali</p>
      </div>
